...
**PhD Committee**: [Samuel Bentolila](https://sites.google.com/view/samuel-bentolila-home){target="_blank"}, [Rafael Repullo](https://www.cemfi.es/~repullo/){target="_blank"}, and [Javier Suarez (supervisor)](https://www.cemfi.es/~suarez/){target="_blank"}.
...
- [Macroeconomics and Climate Change](https://www.cemfi.es/programs/css/course.asp?cu=14){target="_blank"}, by [John Hassler](http://hassler-j.iies.su.se/){target="_blank"} and [Per Krusell](http://perseus.iies.su.se/~pkrus/){target="_blank"}.  
...
- [Machine Learning in Finance](https://www.cemfi.es/programs/css/course_previous_years.asp?c=19&y=2023){target="_blank"}, by [Ansgar Walther](https://ansgarwalther.weebly.com/){target="_blank"}.  
...
- [Introduction to Experimental Analysis](https://www.martin-farias.com/education/intro-experimental-analysis-arkhangelsky/arkhangelsky-experiments-syllabus.pdf){target="_blank"}, by [Dmitry Arkhangelsky](https://sites.google.com/view/dmitry-arkhangelsky/home){target="_blank"}.  
Topics: Static A/B testing, adaptive experiments, dynamic experiments.
- [Unstructured Data in Empirical Economics](https://www.cemfi.es/programs/css/course_previous_years.asp?c=14&y=2021){target="_blank"}, by [Stephen Hansen](https://sekhansen.github.io/){target="_blank"}.  
...
**Master thesis**: "Public Supply of Liquidity to Mutual Funds", supervised by [Javier Suarez](https://www.cemfi.es/~suarez/){target="_blank"}.  
...
In my bachelor I specialized in Quantitative Methods. My thesis supervisor was [Alfredo Schclarek Curutchet](https://cbaeconomia.com/){target="_blank"}, and I worked as teaching and research assistant to [Ángel Enrique (riqui) Neder](https://www.eco.unc.edu.ar/ief/?view=article&id=12487:neder-enrique&catid=187){target="_blank"}.

I would like to highlight the following course that I attended in my last year at Córdoba:

- [Programa de Formación en Normas, Prácticas y Técnicas Bancarias](https://www.eco.unc.edu.ar/contando/957){target="_blank"}, by [BCRA](https://www.bcra.gob.ar/){target="_blank"} and [ABAPPRA](https://abappra.org.ar/){target="_blank"} **(90 hours)**.

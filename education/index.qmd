...
- [Macroeconomics and Climate Change](https://www.cemfi.es/programs/css/course.asp?cu=13), by [John Hassler](http://hassler-j.iies.su.se/) and [Per Krusell](http://perseus.iies.su.se/~pkrus/).  
...
- [Machine Learning in Finance](https://www.cemfi.es/programs/css/course.asp?cu=19), by [Ansgar Walther](https://ansgarwalther.weebly.com/).  
...
- [Introduction to Experimental Analysis](https://www.martin-farias.com/others/courses/intro-experimental-analysis-arkhangelsky/arkhangelsky-experiments-syllabus.pdf), by [Dmitry Arkhangelsky](https://sites.google.com/view/dmitry-arkhangelsky/home).  
Topics: Static A/B testing, adaptive experiments, dynamic experiments.
- [Unstructured Data in Empirical Economics](https://www.cemfi.es/programs/css/course.asp?cu=14), by [Stephen Hansen](https://sekhansen.github.io/).  
